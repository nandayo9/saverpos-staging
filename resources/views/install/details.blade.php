...
<div class="container">
    <div class="row">
        <h3 class="text-center">{{ config('app.name', 'SAVERPOS') }} Installation <small>Step 2 of 3</small></h3>
              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="APP_NAME" id="app_name" placeholder="SAVERPOS" required>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" placeholder="SAVERPOS (Optional)">
                    </div>
                  </div>
