    ...
    <td>
		...
		@if(config('recommerce.enabled'))
			<div class="form-group" style="margin-top:8px">
				...
				<textarea class="form-control input-sm" rows="2" name="products[{{$row_index}}][recommerce_device_codes]" placeholder="Scan or enter one device code per unit"></textarea>
			</div>
		@endif
