...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="perm-manager" id="perm-manager"
          data-lang-search="{{ __('lang_v1.search_permissions') }}"
          data-lang-selectall="{{ __('lang_v1.select_all') }}"
          data-lang-clear="{{ __('lang_v1.deselect_all') }}"
          data-lang-expandall="{{ __('lang_v1.expand_all') }}"
          data-lang-collapseall="{{ __('lang_v1.collapse_all') }}"
          data-lang-granted="{{ __('lang_v1.permissions_granted') }}"
          data-lang-nomatch="{{ __('lang_v1.no_permissions_match') }}">
    ...
    <hr>
      ...
      <div class="col-md-9">
        ...
        @include('role.partials.walk_in_permissions')
        </div><!-- /#perm-manager -->
        <div class="row">
...
@section('css')
  <link rel="stylesheet" href="{{ asset('css/role-permissions.css?v=' . $asset_v) }}">
@endsection

@section('javascript')
  <script src="{{ asset('js/role-permissions.js?v=' . $asset_v) }}"></script>
@endsection
