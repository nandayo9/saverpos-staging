    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase.add_without_price', in_array('purchase.add_without_price', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('lang_v1.add_without_price') }}
                @show_tooltip(__('lang_v1.add_without_price_tooltip'))
              </label>
            </div>
          </div>
        </div>
