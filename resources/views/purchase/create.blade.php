...
<section class="content">
	...
	@endcomponent
	@component('components.widget', ['class' => 'box-primary add_without_price_hide'])
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
	...
	@endcomponent
	@component('components.widget', ['class' => 'box-primary', 'title' => auth()->user()->hidePurchasePrice() ? '' : __('purchase.add_payment')])
		<div class="box-body payment_row">
			<div class="add_without_price_hide">
			<div class="row">
				<div class="col-md-12">
...
@section('javascript')
	...
	<script type="text/javascript">
		$(document).ready( function(){
			...
			// Initialize date picker for cheque due date
    	...
    	$(document).on('change', '.payment_types_dropdown, #location_id', function(e) {
		    ...
		    // Initialize date picker for cheque due date when payment method changes
		    payment_row.find('.date_picker').datepicker({
		        format: datepicker_date_format,
		        autoclose: true,
		    });
		});
