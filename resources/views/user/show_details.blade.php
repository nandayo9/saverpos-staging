...
<div class="row">
	<div class="col-md-12">
		...
		{{-- The four user custom fields are hidden: unless the business has
		     named them they render as "Custom field 1..4" with nothing after
		     the colon, which is the same dead weight that was hidden from the
		     listing tables. --}}
