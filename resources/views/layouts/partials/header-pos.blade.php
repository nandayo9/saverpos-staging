    ...
    <div
        ...
        <div class="tw-w-full md:tw-w-1/3">
            <div class="tw-flex tw-items-center tw-gap-2">
                <a href="{{ route('home') }}" class="tw-flex tw-items-center tw-gap-1.5 tw-mr-2 tw-no-underline" aria-label="SAVERPOS home">
                    <img src="{{ asset('img/saverpos-logo.png') }}" alt="SAVERPOS logo" class="saverpos-logo saverpos-logo--pos">
        ...
        <div class="tw-w-full md:tw-w-2/3 !tw-p-0 tw-flex tw-items-center md:tw-justify-end tw-gap-2 md:tw-gap-1 tw-flex-col md:tw-flex-row tw-hidden md:tw-flex"
            ...
            @if (config('recommerce.enabled', false) && (auth()->user()->can('recommerce.repair.view') || auth()->user()->can('recommerce.repair.intake')))
                <a href="{{ route('recommerce.customer_repairs.index') }}" title="Customer Repairs"
                    class="tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-bg-white hover:tw-bg-white/60 tw-cursor-pointer tw-border-2 tw-flex tw-items-center tw-justify-center tw-rounded-md tw-w-auto tw-h-auto tw-py-1 tw-px-3 tw-text-gray-600 active:tw-scale-95 tw-transition-transform pull-right">
                    <strong class="tw-inline-flex tw-items-center tw-gap-1.5"><i class="fa fa-wrench tw-text-[#B45309]" aria-hidden="true"></i><span>Customer Repairs</span></strong>
                </a>
            @endif
