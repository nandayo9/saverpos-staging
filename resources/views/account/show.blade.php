        ...
        <div class="col-sm-8 col-xs-12">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('created_by_filter', __('lang_v1.added_by') . ':') !!}
                            {!! Form::select('created_by_filter', $users, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'created_by_filter']) !!}
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#created_by_filter').change(function() {
            account_book.ajax.reload();
        });
