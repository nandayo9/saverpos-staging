                                ...
                                <div class="tab-pane active" id="other_accounts">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                {!! Form::select(
                                                    'account_filter_created_by',
                                                    $users,
                                                    null,
                                                    ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'account_filter_created_by'],
                                                ) !!}
                                            </div>
...
@section('javascript')
    <script>
        ...
        scrollCollapse: true,
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.created_by = $('#account_filter_created_by').val();
                    }
                },
                columnDefs: [{
                    "targets": [6, 8],
        ...
        $('#account_filter_created_by').change(function() {
            other_account_table.ajax.reload();
        });
