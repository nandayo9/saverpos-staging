...
class SellReturnController extends Controller
{
     ...
     * @return void
     */
    public function __construct(ProductUtil $productUtil, TransactionUtil $transactionUtil, ContactUtil $contactUtil, BusinessUtil $businessUtil, ModuleUtil $moduleUtil, DeviceLifecycleService $deviceLifecycleService)
    {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($input['products'])) {
                ...
                $this->deviceLifecycleService->recordReturn($request->user(), $sell_return->fresh(), $input['products']);
        ...
        if (request()->ajax()) {
            try {
                ...
                if (!empty($sell_return)) {
                    $this->deviceLifecycleService->reverseReturn(request()->user(), $sell_return);
                }
