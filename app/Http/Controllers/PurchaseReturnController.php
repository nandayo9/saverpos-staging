...
class PurchaseReturnController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            //Users with only "view own purchase" permission see their own purchase returns only
            if (! auth()->user()->can('purchase.view') && auth()->user()->can('view_own_purchase')) {
                $purchases_returns->where('transactions.created_by', request()->session()->get('user.id'));
            }
        ...
        return view('purchase_return.index')->with(compact('business_locations', 'suppliers'));
    }
