$(document).ready(function(){
	...
	*/
	    ...
	    $.ajax({
	        ...
	        success: function(result){
	            if (result.success) {
	                ...
	                toastr.success(result.msg);
	                getScheduleLog(_crmScheduleId || $("input#schedule_id").val());
	            } else {
	                toastr.error(result.msg);
	            }
	        }
	...
	$(document).on('click', '.load_more_log', function() {
	    var url = $(this).data('href');
	    var data = {schedule_id : _crmScheduleId || $("input#schedule_id").val()};
	    $.ajax({
	        method:'GET',
	        dataType: 'json',
	        url: url,
...
var _crmScheduleId = null;

function getScheduleLog(schedule_id, modal_content = false) {
	if (schedule_id) { _crmScheduleId = schedule_id; }
	var data = {schedule_id : _crmScheduleId, modal_content: modal_content};
	$.ajax({
        method: 'GET',
