$(document).ready(function() {
    ...
    purchase_table = $('#purchase_table').DataTable({
        ...
        columns: (function() {
            ...
            { data: 'payment_status', name: 'payment_status', visible: !hide_purchase_price_columns },
            { data: 'final_total', name: 'final_total', visible: !hide_purchase_price_columns },
            { data: 'payment_due', name: 'payment_due', orderable: false, searchable: false, visible: !hide_purchase_price_columns },
