                    ...
                    if (ui.content.length == 1) {
                        ...
                        swal({
                            ...
                            if (value) {
                                ...
                                $.ajax({
                                    url:
                                        '/products/quick_add?product_for=purchase&product_name=' +
    ...
    purchase_table = $('#purchase_table').DataTable({
        ...
        columns: (function () {
            var columns = [
                ...
                { data: 'name', name: 'contacts.name', className: 'text-left' },
...

                {
                    ...
                    visible:
                        typeof customFieldVisibility !== 'undefined'
                            ? customFieldVisibility.custom_field_1
                            : false,
                },
                {
                    data: 'custom_field_2',
                    ...
                    visible:
                        typeof customFieldVisibility !== 'undefined'
                            ? customFieldVisibility.custom_field_2
                            : false,
                },
                {
                    data: 'custom_field_3',
                    ...
                    visible:
                        typeof customFieldVisibility !== 'undefined'
                            ? customFieldVisibility.custom_field_3
                            : false,
                },
                {
                    data: 'custom_field_4',
                    ...
                    visible:
                        typeof customFieldVisibility !== 'undefined'
                            ? customFieldVisibility.custom_field_4
                            : false,
                },

                { data: 'added_by', name: 'u.first_name', className: 'text-left' },
            ];
            if ($('#purchase_device_receiving_enabled').length) {
                columns.splice(6, 0, {
                    data: 'device_receiving',
                    name: 'device_receiving',
                    orderable: false,
                    searchable: false,
                });
            }
