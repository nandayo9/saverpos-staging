...
final class TradeInIntelligenceController {
 ...
 public function index() {
  [$business,$branch]=$this->scope();$records=[];foreach(['VARIANT','REFERENCE','SOURCE','POLICY','MARKET','SIGNAL','MODEL','MODEL_EVENT','JOB','ESTIMATE'] as $kind)$records[$kind]=$this->service->store->all($business,$kind,null,30);
